...
namespace IPStreamingCPP
{
    namespace Controls
    {
        ...
        PageHeader::PageHeader()
        {
            ...
            PageHeader::Loaded += ref new Windows::UI::Xaml::RoutedEventHandler(this, &IPStreamingCPP::Controls::PageHeader::OnLoaded);
            PageHeader::Unloaded += ref new Windows::UI::Xaml::RoutedEventHandler(this, &IPStreamingCPP::Controls::PageHeader::OnUnloaded);
        }
